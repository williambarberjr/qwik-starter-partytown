...
const createPlatform = (doc) => {
    ...
    let storePromise;
    return {
        import: (url) => (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(url),
        toPath: (url) => {
...
exports.qDehydrate = qDehydrate;
exports.qEvent = qEvent;
exports.qHook = qHook;
exports.qRender = qRender;
